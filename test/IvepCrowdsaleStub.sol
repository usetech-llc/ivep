...
import '../contracts/IvepCrowdsale.sol';

contract IvepCrowdsaleStub is IvepCrowdsale {
    function IvepCrowdsaleStub(address _tokenAddress) public
        IvepCrowdsale(_tokenAddress) {
    }
